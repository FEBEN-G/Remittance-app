...
export const mockBanks: Bank[] = [
  { id: 'bank-1', name: 'Commercial Bank of Ethiopia (CBE)', code: 'CBE', logo: '/banks/cbe.png' },
  { id: 'bank-2', name: 'Awash Bank', code: 'AWASH', logo: '/banks/awash.png' },
  { id: 'bank-3', name: 'Dashen Bank', code: 'DASHEN', logo: '/banks/dashen.png' },
  { id: 'bank-4', name: 'Abyssinia Bank', code: 'BOA', logo: '/banks/boa.png' },
  { id: 'bank-5', name: 'Wegagen Bank', code: 'WEGAGEN', logo: '/banks/wegagen.png' },
  { id: 'bank-6', name: 'Hibret Bank', code: 'HIBRET', logo: '/banks/hibret.png' },
  { id: 'bank-7', name: 'NIB International Bank', code: 'NIB', logo: '/banks/nib.png' },
  { id: 'bank-8', name: 'Zemen Bank', code: 'ZEMEN', logo: '/banks/zemen.png' },
  { id: 'bank-9', name: 'Bunna International Bank', code: 'BUNNA', logo: '/banks/bunna.png' },
  { id: 'bank-10', name: 'Berhan Bank', code: 'BERHAN', logo: '/banks/berhan.png' },
  { id: 'bank-11', name: 'Abay Bank', code: 'ABAY', logo: '/banks/abay.png' },
  { id: 'bank-12', name: 'Enat Bank', code: 'ENAT', logo: '/banks/enat.png' },
  { id: 'bank-13', name: 'Cooperative Bank of Oromia', code: 'COOPBANK', logo: '/banks/coop.png' },
];
...
export const mockExchangeRate: ExchangeRate = {
  ...
  rate: 126.50,
  bonusRate: 0.10,
  effectiveRate: 126.60,
  date: new Date().toISOString(),
  currency: 'USD',
};

export const mockRateHistory: ExchangeRateHistory[] = Array.from({ length: 30 }, (_, i) => {
  const date = new Date();
  date.setDate(date.getDate() - (29 - i));
  return {
    date: date.toISOString().split('T')[0],
    rate: 125 + Math.random() * 3,
  };
});
...
export const mockNotifications: Notification[] = [
  {
    ...
    message: 'Your transfer of $200 to Abebe Bekele has been completed successfully. The recipient should receive the funds within 24 hours.',
    read: false,
  ...
  },
  {
    ...
    message: 'We noticed a new sign-in to your account from Chrome on Windows. If this was you, you can ignore this message.',
    read: false,
  ...
  },
  {
    ...
    type: 'kyc',
    title: 'KYC Approved',
    message: 'Your KYC Level 1 verification has been approved. You can now send up to $500 per transaction.',
    read: true,
  ...
  },
  {
    ...
    message: 'Get an extra 0.10 ETB per dollar on all transfers this week! Limited time offer ends Sunday.',
    read: false,
  ...
  },
  {
    ...
    message: 'Your friend John Smith just made their first transfer! You earned $5.00 referral bonus.',
    read: true,
  ...
  },
  {
    ...
    message: 'We will be performing scheduled maintenance on March 5th from 2:00 AM to 4:00 AM EST. Services may be temporarily unavailable.',
    read: true,
...
export const mockDonationCauses: DonationCause[] = [
  {
    ...
    description: 'Help provide quality education to underprivileged children in Ethiopia',
...
export const mockCrowdfundingCampaigns: CrowdfundingCampaign[] = [
  ...
  },
  {
    ...
    description: 'Provide school supplies for 50 children at Kidane Mihret Orphanage',
...
// Helper functions
export function calculateTransactionSummary(amountUSD: number, rate: ExchangeRate) {
  const fee = amountUSD < 100 ? 1.99 : amountUSD < 300 ? 3.99 : amountUSD < 500 ? 5.99 : 7.99;
