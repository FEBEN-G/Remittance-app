...
export const metadata: Metadata = {
  ...
  description: 'Send money to Ethiopia instantly. Best exchange rates, low fees, secure transfers to any Ethiopian bank account.',
  keywords: ['remittance', 'Ethiopia', 'money transfer', 'ETB', 'send money', 'diaspora'],
