  ...
  return (
    <div className="relative min-h-screen flex flex-col overflow-hidden bg-background text-foreground selection:bg-primary/30">
      ...
      <div className="pointer-events-none fixed inset-0 -z-10 flex justify-center">
        <div
          className="absolute top-[-20%] h-200 w-200 rounded-full bg-primary/5 blur-[120px] animate-pulse"
          style={{ animationDuration: "10s" }}
        />
        <div
          className="absolute right-[-10%] top-[40%] h-120 w-120 rounded-full bg-secondary/5 blur-[100px] animate-pulse"
